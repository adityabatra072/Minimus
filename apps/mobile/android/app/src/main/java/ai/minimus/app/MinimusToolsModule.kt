 ...
 */
class MinimusToolsModule(private val ctx: ReactApplicationContext) :
    ReactContextBaseJavaModule(ctx) {

    override fun getName() = "MinimusTools"
    ...
    companion object {
        private const val CHANNEL_ID = "minimus_agent"
    }
}
