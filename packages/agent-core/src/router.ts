...
export const ROUTER_SECTION = [
  ...
  '- memory: remembering a fact for later, or recalling something the user told you before.',
  ...
  'Examples: "hello" → none · "Morning! How are you doing?" → none · "what is the weather like in London right now" → web · "what is my locker code" → memory · "what was the wifi password I told you" → memory · "what did I ask you to do when I say wind down" → memory · "thanks, that was great" → none · "what is the capital of France" → none · "tell me a joke" → none · "what can you do" → none · "turn on the flashlight" → phone · "how much battery do I have" → phone · "what have I got on Friday" → calendar · "set a timer for 12 minutes" → calendar · "remember that my locker code is 4471" → memory · "what did I tell you about Thursday" → memory · "in 20 minutes check my battery and tell me if it dropped" → later · "new rule: when I say wind down, dim the screen" → teach · "who won the Monaco Grand Prix" → web · "let Sam know I am running late" → messages · "put on something by Radiohead" → music',
].join('\n');
